...
/* themes/contrib/yaudaface_theme/templates/paragraphs/paragraph--cavalla-featurette.html.twig */
class __TwigTemplate_df2c00aecc549e2f70556cfebbdc6f98f17119e8c2161540f642e46f107588a5 extends \Twig\Template
{
    ...
    {
        // line 1
        echo "<section class=\"w-100 d-md-table featurette_bundle featurette_bundle_override\" aria-label=\"Featurettes\" data-animate-featurette=\"";
...
\t\t\t";
        ...
        if ((($context["float_left"] ?? null) == 1)) {
            // line 6
            echo "\t\t   \t\t<div class=\"col-lg-2 col-md-2 right featurettes_text my-auto d-md-table-cell align-middle\">
\t\t\t  \t\t<aside class=\"featurette text-center text-md-left mb-3\">
\t\t\t\t\t  ";
            // line 8
...
\t\t\t\t\t  </section>
          \t\t\t  ";
            ...
            echo "\t\t\t\t\t</aside>
\t\t\t\t</div>
\t\t   \t\t<div class=\"col-lg-10 col-md-10 featurettes_image d-md-table-cell align-middle ";
            // line 23
...
\t\t\t";
        ...
        if ((($context["float_left"] ?? null) == 0)) {
            // line 29
            echo "\t\t\t<div class=\"col-lg-10 col-md-10  featurettes_image  ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["circular_image"] ?? null)), "html", null, true);
            echo "\">
\t\t\t\t<div class=\"parallax\" style=\"background-image:url('";
            // line 30
            ...
            echo "')\">&nbsp;</div>
\t\t\t</div>
\t\t\t <div class=\"col-lg-2 col-md-2 left featurettes_text my-auto \">
\t\t\t \t<aside class=\"featurette text-center text-md-left mb-3\">
\t\t\t\t\t";
            // line 34
            if (twig_in_filter(true, $this->getAttribute($this->getAttribute(($context["content"] ?? null), "field_featurette_header", []), 0, [], "array"))) {
...
";
    ...
    {
        return "themes/contrib/yaudaface_theme/templates/paragraphs/paragraph--cavalla-featurette.html.twig";
    }
    ...
    {
        return new Source("<section class=\"w-100 d-md-table featurette_bundle featurette_bundle_override\" aria-label=\"Featurettes\" data-animate-featurette=\"{{ content.field_featurettes_animation[0] }}\">
\t<section class=\"featurettes d-md-table-cell align-middle\">
\t\t<section class=\"container\">
\t\t\t<div class=\"row h-100\">
\t\t\t{%  if float_left == 1 %}
\t\t   \t\t<div class=\"col-lg-2 col-md-2 right featurettes_text my-auto d-md-table-cell align-middle\">
\t\t\t  \t\t<aside class=\"featurette text-center text-md-left mb-3\">
...
\t\t\t\t\t</aside>
\t\t\t\t</div>
\t\t   \t\t<div class=\"col-lg-10 col-md-10 featurettes_image d-md-table-cell align-middle {{ circular_image }}\"2\t>
\t\t\t\t   <div class=\"parallax\" style=\"background-image:url('{{ image_url }}')\">&nbsp;</div>
\t\t\t\t</div>
\t\t   {% endif %}

\t\t\t{%  if float_left == 0 %}
\t\t\t<div class=\"col-lg-10 col-md-10  featurettes_image  {{ circular_image }}\">
\t\t\t\t<div class=\"parallax\" style=\"background-image:url('{{ image_url }}')\">&nbsp;</div>
\t\t\t</div>
\t\t\t <div class=\"col-lg-2 col-md-2 left featurettes_text my-auto \">
\t\t\t \t<aside class=\"featurette text-center text-md-left mb-3\">
...
", "themes/contrib/yaudaface_theme/templates/paragraphs/paragraph--cavalla-featurette.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/cavalla_projects/themes/contrib/yaudaface_theme/templates/paragraphs/paragraph--cavalla-featurette.html.twig");
    }
}
